/*
 ...
 AW: Modified original base64 code into base64url
 */
///
...
std::string ctvc::base64url_encode(unsigned char const *bytes_to_encode, unsigned int in_len)
{
    std::string ret;
    int i = 0;
...
std::vector<unsigned char> ctvc::base64url_decode(std::string const &encoded_string)
{
    ...
    while (in_len-- && is_base64url(encoded_string[in_])) {
